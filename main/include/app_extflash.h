...
#define EXTFLASH_CS_PIN    CONFIG_EXTFLASH_CS_PIN
#define EXTFLASH_CLK_PIN   CONFIG_EXTFLASH_CLK_PIN
#define EXTFLASH_MOSI_PIN  CONFIG_EXTFLASH_MOSI_PIN
#define EXTFLASH_MISO_PIN  CONFIG_EXTFLASH_MISO_PIN
